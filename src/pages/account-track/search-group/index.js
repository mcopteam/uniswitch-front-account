      ...
      onSubmit={this.handleSearch.bind(this)}>
        ...
        <Row>
          <Col span={24} key='submit' style={{textAlign: 'right'}}>
            ...
            <Button type="primary" htmlType="submit" style={{display:btnIsShow(buttonList,button_list.query_accounttraceKey)?"inline-block":"none"}}>{button_list.query_accounttraceName}</Button>
          </Col>
        </Row>
      </Form>
    )
