      ...
      onSubmit={this.handleSearch.bind(this)}>
        ...
        <Row>
          <Col span={24} key='submit' style={{textAlign: 'right'}}>
            ...
            <Button type="primary" htmlType="submit" style={{display:btnIsShow(buttonList,button_list.query_contractproductinfileKey)?"inline-block":"none"}}>{button_list.query_contractproductinfileName}</Button>
          </Col>
        </Row>
      </Form>
    )
