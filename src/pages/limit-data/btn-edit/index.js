...
import { actionDataEdit } from  '../../../actions/limit-data'
  ...
  constructor(props) {
    ...
    const formItemLayout = {
      ...
      wrapperCol: {
		...
		return(
  		<Modal className="menu-info-model" title="数据资源编辑" visible={show}
        okText="保存"
            ...
            <FormItem
              ...
              <div className="input-wrap">
                {getFieldDecorator('fullName', {
                    rules: [{ required: true, message: '请输入数据全名'}],
            ...
            <FormItem
              ...
              <div className="input-wrap">
                {getFieldDecorator('link', {
                    rules: [{ required: true, message: '请输入数据链接'}],
            ...
            <FormItem
              ...
              <div className="input-wrap">
                {getFieldDecorator('parentId', {
                    rules: [{ required: true, message: '请输入父数据ID'}],
            ...
            <FormItem
              ...
              <div className="input-wrap">
                {getFieldDecorator('orderNum', {
                    rules: [{ required: true, message: '请输入数据顺序编号'}],
            ...
            <FormItem
              ...
              <div className="input-wrap">
                {getFieldDecorator('note', {
                    rules: [{ required: true, message: '请输入数据说明'}],
...
const mapDispatchToProps = (dispatch) => {
  return {
    submitEdit: (info, search, pag) => {
      actionDataEdit(dispatch, info, search, pag);
    },
  }
}
